...
from .admin_views import (ProjectAdminView, AllProjectsView, TagsAdminView,
                          ...
                          BlogImagesAdminView, AllBlogsView, LogoutView)  # UserAdminView


admin = Admin(app, 'Go to MyArt', index_view=AllProjectsView(),
              template_mode='bootstrap4', url='/')
admin.add_view(ModelView(User, db.session))
# admin.add_view(SignInView(name='Registration', url='register'))
...
admin.add_view(LogoutView(name='Logout (Click to logout)', endpoint='index'))
